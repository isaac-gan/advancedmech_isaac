...
#include <string.h> // for memset. (Clear fxn uses fxn memset to delete all the pixels)
...
void ssd1306_setup() { //initialisation fxn
    ...
    ssd1306_clear(); //clear mem and update so all pixels are off
    ssd1306_update();
}
...
//ref I2C noint code to get the I2C commands
